...
def create_report():
    ...
    objs = [
        ...
        'To demonstrate advanced DBA practices including tablespace separation (TS_ECOMM_DATA & TS_ECOMM_IDX), B-Tree indexing, execution plan cost optimization (DBMS_XPLAN), and PL/SQL package implementation.'
    ]
    ...
    doc.add_paragraph(
        ...
        '• Customers → Orders (1:M): A customer can place multiple orders.\n'
        '• Orders → Order Items (1:M): An order can contain multiple product line items.\n'
        '• Products → Order Items (1:M): A product can appear across multiple order items.\n'
    ...
    tech_rows = [
        ...
        ('node-oracledb (Thin Mode)', 'Official native Oracle driver communicating via TCP port 1521 without Oracle Client binaries'),
    ...
    for title, desc in screenshots:
        ...
        # Box for screenshot placeholder
    ...
    output_path = r'C:\Users\Sriram\.gemini\antigravity\scratch\online-shopping-dba\Ajay_Raja_Online_Shopping_Database_Report.docx'
